...
public class RefactoringDataManagement extends DataManagementAdapter 
	...
	private void addPorts(){
		...
		this.inPorts.add
			(new Port<String>
				("eReferenceName_1", String.class, "unspecified"));
		this.inPorts.add
			(new Port<String>
				("eReferenceName_2", String.class, "unspecified"));		
	}
	...
	private void addInformation() {			
		this.finalConditionsInformation.
				setTransformationFileName("create_referenced_eclass_finalcheck");			
		this.createChangeInformation.
				setTransformationFileName("create_referenced_eclass_execute");
	}

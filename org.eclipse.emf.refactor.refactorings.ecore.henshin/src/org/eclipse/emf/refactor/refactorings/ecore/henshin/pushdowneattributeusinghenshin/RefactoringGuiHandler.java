 ...
 * </copyright>
 *
 * $Id: RefactoringGuiHandler.java,v 1.1 2011/01/19 12:09:32 tarendt Exp $
 */
...
public class RefactoringGuiHandler implements IGuiHandler {
	...
	public RefactoringWizard show() {
		return new org.eclipse.emf.refactor.refactorings.ecore.henshin.pushdowneattributeusinghenshin.RefactoringWizard
	...
	public boolean showInMenu(List<EObject> selection) {
		for(EObject o:selection){
			if(null != o){
				if (o instanceof org.eclipse.emf.ecore.EAttribute) {
					return true;
				}
			} 
		}

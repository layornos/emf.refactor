...
public class RefactoringGuiHandler implements IGuiHandler {
	...
	public RefactoringWizard show() {
		return new org.eclipse.emf.refactor.refactorings.ecore.henshin.renameereferenceusinghenshin.RefactoringWizard
	...
	public boolean showInMenu(List<EObject> selection) {
		for(EObject o:selection){
			if(null != o){
				if (o instanceof org.eclipse.emf.ecore.EReference) {
					return true;
				}
			} 
		}

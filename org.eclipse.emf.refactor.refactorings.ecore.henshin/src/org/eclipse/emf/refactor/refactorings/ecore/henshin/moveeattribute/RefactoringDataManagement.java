 ...
 * </copyright>
 *
 * $Id: RefactoringDataManagement.java,v 1.1 2011/01/19 12:09:32 tarendt Exp $
 */
...
public class RefactoringDataManagement extends DataManagementAdapter 
	...
	private void addInformation() {		
		this.initialConditionsInformation.
				setTransformationFileName("move_eattribute_initialcheck");			
		this.finalConditionsInformation.
				setTransformationFileName("move_eattribute_finalcheck");			
		this.createChangeInformation.
				setTransformationFileName("move_eattribute_execute");
	}

 ...
 * </copyright>
 *
 * $Id: RefactoringGuiHandler.java,v 1.1 2011/01/19 12:09:30 tarendt Exp $
 */
...
public class RefactoringGuiHandler implements IGuiHandler {
	...
	public RefactoringWizard show() {
		return new org.eclipse.emf.refactor.refactorings.ecore.henshin.pullupeattributeusinghenshin.RefactoringWizard

...
public final class MaxDIT implements IMetricCalculator {

		
	private List<EObject> context; 
	private String metricId = "org.eclipse.emf.refactor.metrics.uml24.maxditc";
	...
	public double calculate() {	
		EList<Double> dits = new BasicEList<Double>();
		...
		while (iter.hasNext()) {
			...
			if (eObject instanceof Class) {
				...
				dits.add(calc.calculate());
			}			
		}
		return maxDITs(dits);
	}

	private double maxDITs(EList<Double> doubles) {
		Double result = 0.0;

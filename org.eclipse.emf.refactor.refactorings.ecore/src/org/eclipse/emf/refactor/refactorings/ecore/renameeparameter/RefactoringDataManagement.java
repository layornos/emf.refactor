...
public class RefactoringDataManagement extends DataManagementAdapter {
	...
	private void addPorts(){
		this.inPorts.add
			(new Port<org.eclipse.emf.ecore.EParameter>
				(SELECTEDEOBJECT, org.eclipse.emf.ecore.EParameter.class));
		this.inPorts.add
			(new Port<String>
	...
	public void preselect(List<EObject> selection) {
		getInPortByName(SELECTEDEOBJECT).
				setValue((org.eclipse.emf.ecore.EParameter) selection.get(0));
	}

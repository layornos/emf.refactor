...
public class RefactoringTest extends JUnitTestCaseAdapter {
	...
	public RefactoringTest(String number) throws IOException {
		super("de.unimarburg.swt.refactorings.uml.removeemptysubclass",
			"uml",
	...
	private static List<String> getTestNumbers() {
		...
		try {
			String pathPrefix = new File(".").getCanonicalPath() + "/tests/" + "de.unimarburg.swt.refactorings.uml.removeemptysubclass";

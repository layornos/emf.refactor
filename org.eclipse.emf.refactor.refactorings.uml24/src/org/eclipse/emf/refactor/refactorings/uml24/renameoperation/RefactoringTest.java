...
import org.eclipse.emf.refactor.refactorings.uml24.renameoperation.RefactoringController;
import org.eclipse.emf.refactor.refactorings.uml24.renameoperation.RefactoringGuiHandler;
...
public class RefactoringTest extends JUnitTestCaseAdapter {
	...
	public RefactoringTest(String number) throws IOException {
		super("org.eclipse.emf.refactor.refactorings.uml24.RenameMethod",
			"uml",
	...
	private static List<String> getTestNumbers() {
		...
		try {
			String pathPrefix = new File(".").getCanonicalPath() + "/tests/" + "de.unimarburg.swt.refactorings.uml.renameoperation";
